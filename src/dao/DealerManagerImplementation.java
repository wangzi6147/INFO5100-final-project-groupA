...
public class DealerManagerImplementation implements DealerManager {
    Connection conn;

    public DealerManagerImplementation() {
        conn = DBconnect.connectDB();
    }

    /**
     * find Dealers By PostCode Within Lines
     * method overloading
     * parameters = postCode , lines
     *
     * @throws SQLException
     */
